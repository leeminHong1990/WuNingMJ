...
var GameRoomInfoUI = UIBase.extend({
	...
	initUI:function(){
		...
		var cur_round_label = this.rootUINode.getChildByName("roominfo_panel").getChildByName("cur_round_label")
		cur_round_label.ignoreContentAdaptWithSize(true);
		cur_round_label.setString("局数:" + player.curGameRoom.maxRound.toString())
	},
