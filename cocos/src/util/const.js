...
const_val.OP_DRAGON_GREEN_KONG= 5 // 杠单张发财
...
const_val.OP_GIVE_WIN         = 13// 放炮胡
const_val.OP_KONG_WIN         = 14// 抢杠胡
const_val.OP_WREATH_WIN       = 15// 杠花胡
const_val.OP_DRAW_END         = 16// 流局
const_val.OP_CUT              = 17 // 杠后切牌
const_val.OP_NUM              = 18 // 操作总数
